...
export default function ManageTypesPage() {
  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {machineTypes.length === 0 ? (
          <div
            ...
            className="text-center py-12 rounded-lg shadow-elevation-medium"
          >
            ...
            {machineTypes.map((type) => {
              ...
              return (
                <div
                  key={type.id}
                  style={{ backgroundColor: "hsl(var(--color-card))" }}
                  className="rounded-lg p-6 shadow-elevation-medium"
                >
                  ...
                  >
                    {machineCount} machine(s) • {type.attributes.length}{" "}
                    attribute(s)
                  </p>
      ...
      {isCreating && <MachineTypeForm onClose={() => setIsCreating(false)} />}
