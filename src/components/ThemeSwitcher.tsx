  ...
  if (!mounted) {
    return (
      <button
        ...
        disabled
      >
        <span style={{ backgroundColor: 'white' }} className="absolute left-1 top-0.5 w-6 h-6 rounded-full flex items-center justify-center text-sm transition-transform duration-300">
          ☀️
        </span>
      </button>
    );
